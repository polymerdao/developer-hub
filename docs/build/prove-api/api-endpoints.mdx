...
- If you wish to prove a single log, you will also need to provide an `logIndex` of the desired event within the receipt. See the method details below for further information.
