...
This guide explains how to interpret and decode the returns from the `CrossL2ProverV2` contract, using a practical [simple key-value app example](<../../learn/use-cases/simple-key-value-app.mdx>) to demonstrate the complete process.
</Admonition>
