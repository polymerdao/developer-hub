...
→ [How Prove API works](./how-prove-api-works.mdx) for the mechanism, the security model, and what your own contract still has to check
...
| Know what you are trusting | [How Prove API works](./how-prove-api-works.mdx) |
