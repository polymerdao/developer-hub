...
:::warning
These checks are part of the integration, not optional hardening. [Prover Integration](<../get started/prove-api-V2/decodingProverReturn.mdx>) walks through each one with code,.
:::
