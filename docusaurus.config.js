...
const config = {
    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          { from: '/docs/build/why polymer/examples/simple-key-value-app', to: '/docs/build/learn/use-cases/simple-key-value-app' },
          { from: '/docs/build/why polymer/examples/multi-rollup_apps', to: '/docs/build/learn/use-cases/simple-key-value-app' },
          { from: '/docs/build/why polymer/examples/chain_abstraction', to: '/docs/build/learn/use-cases/chain_abstraction' },
          // Examples folded into Learn -> Use Cases.
          { from: '/docs/build/examples/simple-key-value-app', to: '/docs/build/learn/use-cases/simple-key-value-app' },
          { from: '/docs/build/examples/chain_abstraction', to: '/docs/build/learn/use-cases/chain_abstraction' },
        ],
      },
    ],
  ],
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/Gradient + Transparent BG.png',
      navbar: {
        title: 'Docs',
        hideOnScroll: false,
        logo: {
